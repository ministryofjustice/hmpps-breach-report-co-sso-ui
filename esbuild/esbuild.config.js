...
const buildConfig = {
  ...
  assets: {
    ...
    copy: [
      ...
      {
        from: path.join(cwd, 'node_modules/govuk-frontend/**/*'),
        to: path.join(cwd, 'dist/node_modules/govuk-frontend'),
      },
      {
        from: path.join(cwd, 'node_modules/@ministryofjustice/frontend/**/*'),
        to: path.join(cwd, 'dist/node_modules/@ministryofjustice/frontend'),
      },
    ],
