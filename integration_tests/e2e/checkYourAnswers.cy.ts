context('Check your answers', () => {
  it('Basic Details populated', () => {
    ...
    cy.get('#page-title').should('contain.text', 'Breach Report CO SSO - Check Your Answers')
  ...
  it('Basic Details not saved', () => {
    cy.visit('/check-your-answers/9c7f4a6d-3e2b-4d8f-9b61-2c7f5a9e1d34')
    cy.url().should('include', '/check-your-answers')
  ...
  it('Offence Details populated', () => {
    ...
    cy.get('#suspended-custody-length').should('contain.text', '10 Days')
  ...
  it('RO and witness details populated', () => {
    ...
    cy.get('#work-address-building-number-street-name').should('contain.text', '2').and('contain.text', 'Work Address')
