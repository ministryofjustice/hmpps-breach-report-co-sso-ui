context('Check your answers', () => {
  it('Basic Details populated', () => {
    ...
    cy.get('#postal-address-building-number-street-name').should('contain.text', '1').and('contain.text', 'Older Postal Address')
  ...
  it('Offence Details populated', () => {
    ...
    cy.get('#requirement-info-1').should('contain.text', 'Requirement Type Main Category Description')
      .and('contain.text', '20 Months').and('contain.text', '12 Months')
    cy.get('#requirement-info-2').should('contain.text', 'Another Main Category Description')
      .and('contain.text', '2 Months').and('contain.text', '1 Months')
    cy.get('#amendment-info-1').should('contain.text', 'TEST DETAILS')
      .and('contain.text', 'TEST REASON').and('contain.text', '2026-01-14')
    cy.get('#amendment-info-2').should('contain.text', 'SECOND DETAILS')
      .and('contain.text', 'SECOND REASON').and('contain.text', '2025-12-25')
  ...
  it('RO and witness details populated', () => {
    ...
    cy.get('#work-address-building-number-street-name').should('contain.text', '2').and('contain.text', 'Older Postal Address')
